...
def say(module, msg, voice, pitch):
    module.run_command(["/usr/bin/say", '[[pbas %s] % (pitch) msg', "--voice=%s" % (voice)], check_rc=True)
...
def main():
    ...
    module = AnsibleModule(
        argument_spec=dict(
            ...
            pitch=dict(required=False, default=60)
        ),
    ...
    pitch = module.params['pitch']

    say(module, msg, voice, pitch)
